...
namespace Janos_Nagy_Lab2.Data
{
    public class Janos_Nagy_Lab2Context : DbContext
    {
        ...
        public DbSet<Janos_Nagy_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Janos_Nagy_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Janos_Nagy_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
